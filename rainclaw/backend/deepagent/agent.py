...
架构：
  - HybridSandboxBackend 作为默认后端：
    - 文件操作（read_file/write_file/edit_file/ls/glob/grep）→ 本地 /home/rainclaw/
...
_SYSTEM_PROMPT_TEMPLATE = """You are RainClaw, a proactive personal AI assistant designed to help users solve problems, conduct research, and complete tasks efficiently.
...
_EVAL_SYSTEM_PROMPT_TEMPLATE = """You are RainClaw, a proactive personal AI assistant designed to help users solve problems, conduct research, and complete tasks efficiently.
...
async def deep_agent(
    ...
    """
    ts: TaskSettings = task_settings or TaskSettings()
    ...
    sandbox_info = None
    actual_workspace = sandbox.workspace  # /home/rainclaw/{session_id}（与后端共享卷）
