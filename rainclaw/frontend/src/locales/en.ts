export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'RainClaw Computer': 'RainClaw Computer',
  'RainClaw is using': 'RainClaw is using',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give RainClaw a task to work on...': 'Give RainClaw a research task...',
  // Shell tools
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to RainClaw': 'Login to RainClaw',
  'Register to RainClaw': 'Register to RainClaw',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'You are viewing a completed RainClaw task. Replay will start automatically in {countdown} seconds.': 'You are viewing a completed RainClaw task. Replay will start automatically in {countdown} seconds.',
  ...
  'No datasources yet': 'No datasources yet',
  'Click "New Datasource" to create one': 'Click "New Datasource" to create one',
  ...
  'Operation': 'Operation',
  'Search datasource name...': 'Search datasource name...',
  'Query': 'Query',
  'Reset': 'Reset',
  'Delete Confirm': 'Confirm Delete',
  'Delete datasource confirm message': 'Are you sure you want to delete this datasource? This action cannot be undone.',
  ...
  'Datasource code unique tip': 'Each datasource code must be unique',
  'Select type': 'Select type',
  'Failed to create datasource': 'Failed to create datasource',
  'Failed to update datasource': 'Failed to update datasource',
  'Failed to delete datasource': 'Failed to delete datasource',
  'Failed to load datasources': 'Failed to load datasources',
